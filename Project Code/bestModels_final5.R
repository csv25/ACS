...
svm_cm_yes <- confusionMatrix(svm_preds, testDataBORUTA$Class, positive = 'Yes') 
svm_cm_yes 
...
svm_roc <- roc(testDataBORUTA_df1$Class, attr(svm_preds, "probabilities")[, "Yes"])
svm_roc 
...
roc(testData_BORUTA$Class, predict(svm_model, testData_BORUTA, type = "prob")[, "Yes"])
# ROC: 0.8117
plot(roc(testData_BORUTA$Class, predict(svm_model, testData_BORUTA, type = "prob")[, "Yes"]))
...
### Class-weighted SVM : From the book (Applied Predictive Modeling)
library(kernlab)
set.seed(123)
...
roc(testData_CORR_df1$Class, predict(SVMwts_model, testData_CORR_df1, type = "prob")[, "Yes"])
# ROC: 0.8486
plot(roc(testData_CORR_df1$Class, predict(SVMwts_model, testData_CORR_df1, type = "prob")[, "Yes"]))


SVMwts_preds <- predict(SVMwts_model, testData_CORR_df1)
SVMwt_cm_no <- confusionMatrix(SVMwts_preds, testData_CORR_df1$Class)
SVMwt_cm_no

svm_cm_no <- SVMwt_cm_no$table
tp <- svm_cm_no["No", "No"]     
fn <- svm_cm_no["Yes", "No"]    
fp <- svm_cm_no["No", "Yes"]    
tn <- svm_cm_no["Yes", "Yes"]   
...
SVMwt_cm_yes <- confusionMatrix(SVMwts_preds, testData_CORR_df1$Class, positive = 'Yes')
SVMwt_cm_yes

svm_cm_yes <- SVMwt_cm_yes$table
tn <- svm_cm_yes["No", "No"]    
fp <- svm_cm_yes["Yes", "No"]   
fn <- svm_cm_yes["No", "Yes"]   
tp <- svm_cm_yes["Yes", "Yes"]  
