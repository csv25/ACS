...
## Students : Melanie R Loaiza,  and Carlos Vargas, 
## ** ------------------------------------------------------------------------------------ **  
...
svm_preds <- predict(svm_model, testDataRFEA, probability = TRUE)
...
plot(svm_model)
roc(testDataBORUTA_df1$Class, predict(svm_model, testDataBORUTA_df1, type = "prob")[, "Yes"])
# ROC: 0.849
plot(roc(testDataBORUTA_df1$Class, predict(svm_model, testDataBORUTA_df1, type = "prob")[, "Yes"]))
